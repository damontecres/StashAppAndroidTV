...
fun FilterParser.convertPerformerFilterType(f: Any?): PerformerFilterType? =
    if (f != null && f is PerformerFilterType) {
        ...
        PerformerFilterType(
            ...
            career_start = Optional.presentIfNotNull(convertDateCriterionInput(filter["career_start"])),
            career_end = Optional.presentIfNotNull(convertDateCriterionInput(filter["career_end"])),
