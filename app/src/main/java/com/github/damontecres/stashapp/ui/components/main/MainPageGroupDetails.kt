...
import com.github.damontecres.stashapp.ui.groupPreview
    ...
    Column(
        ...
        Column(
                ...
                DotSeparatedRow(
                    ...
                    texts =
                        listOfNotNullOrBlank(
                            group.date,
                            group.duration?.seconds?.toString(),
                        ),
                )
            }
            // Description
            if (group.synopsis.isNotNullOrBlank()) {
                Text(
                    text = group.synopsis,
            ...
            Row(
                ...
                if (group.director.isNotNullOrBlank()) {
                    TitleValueText(
...
@Composable
private fun MainPageGroupDetailsPreview() {
    PreviewTheme {
        MainPageGroupDetails(
            group = groupPreview,
