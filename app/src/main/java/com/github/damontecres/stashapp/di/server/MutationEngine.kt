...
class MutationEngine(
    ...
    suspend fun <D : Mutation.Data> executeMutation(
        ...
        withContext(Dispatchers.IO) {
            ...
            Logger.v { "executeMutation $id $mutationName start" }
            val response = client.mutation(mutation).execute()
            if (response.data != null) {
                Logger.v { "executeMutation $id $mutationName successful" }
                ...
                Logger.e { "Errors in $id $mutationName: ${response.errors}" }
    ...
    suspend fun incrementPlayCount(sceneId: String): Int {
        Logger.v { "incrementPlayCount on $sceneId" }
    ...
    suspend fun setTagsOnScene(
        ...
        Logger.v { "setTagsOnScene sceneId=$sceneId, tagIds=$tagIds" }
        val mutation =
            SceneUpdateMutation(
                input =
                    SceneUpdateInput(
    ...
    suspend fun setGroupsOnScene(
        ...
        Logger.v { "setGroupsOnScene sceneId=$sceneId, tagIds=$groupIds" }
        val mutation =
            SceneUpdateMutation(
                input =
                    SceneUpdateInput(
    ...
    suspend fun setTagsOnMarker(
        ...
        Logger.v { "setTagsOnMarker markerId=$markerId, primaryTagId=$primaryTagId, tagIds=$tagIds" }
        return updateMarker(
    ...
    suspend fun setPerformersOnScene(
        ...
        Logger.v { "setPerformersOnScene sceneId=$sceneId, performerIds=$performerIds" }
        val mutation =
            SceneUpdateMutation(
                input =
                    SceneUpdateInput(
    ...
    suspend fun setStudioOnScene(
        ...
        Logger.v { "setStudioOnScene sceneId=$sceneId, studioId=$studioId" }
        val mutation =
            SceneUpdateMutation(
                input =
                    SceneUpdateInput(
    ...
    suspend fun setGalleriesOnScene(
        ...
        Logger.v { "setGalleriesOnScene sceneId=$sceneId, galleryIds=$galleryIds" }
        val mutation =
            SceneUpdateMutation(
                input =
                    SceneUpdateInput(
    ...
    suspend fun setRating(
        ...
        Logger.v { "setRating sceneId=$sceneId, rating=$rating100" }
        val mutation =
            SceneUpdateMutation(
                input =
                    SceneUpdateInput(
