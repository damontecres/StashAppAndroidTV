...
private val PerformerFilterOptions =
    listOf(
        ...
        FilterOption<PerformerFilterType, DateCriterionInput>(
            "career_start",
            R.string.stashapp_career_start,
            null,
            DateCriterionInput::class,
            { filter -> filter.career_start },
            { filter, value -> filter.copy(career_start = value) },
            TwoValueCriterionModifiers,
        ),
        FilterOption<PerformerFilterType, DateCriterionInput>(
            "career_end",
            ...
            null,
            DateCriterionInput::class,
            { filter -> filter.career_end },
            { filter, value -> filter.copy(career_end = value) },
            TwoValueCriterionModifiers,
        ),
        FilterOption<PerformerFilterType, StringCriterionInput>(
            "country",
