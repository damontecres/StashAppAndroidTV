...
| :--- | :--- | :--- | :--- |
| **Maintenance** | `Feature` | **Scene-Bewertungen direkt im Player:** Eine Option "Rate" im Drei-Punkte-Menü des Players öffnet nun ein Dialog-Overlay mit der Stash-Bewertungsanzeige (Sterne/Dezimal). Ermöglicht komfortables Bewerten während laufender Wiedergabe ohne Verlassen des Players. | Low |
